...
# ---------------------------------------------------------
# 5. SIDEBAR - ΦΙΛΤΡΑ (DEFAULT = ΟΛΑ ΤΑ ΔΕΔΟΜΕΝΑ)
# ---------------------------------------------------------
...
# Αν ΔΕΝ έχει επιλεγεί τίποτα, κρατάμε ΟΛΟΥΣ τους μήνες
if selected_months:
...
# Αν ΔΕΝ έχει επιλεγεί τίποτα, κρατάμε ΟΛΕΣ τις εβδομάδες
if selected_weeks:
